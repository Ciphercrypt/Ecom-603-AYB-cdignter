...
$route['mysubscription'] = "Users/mysubscription";

$route['mysubscription/month'] = "Users/getUserhistorybymonth";
...
$route['admin/cashondel'] = "admin/ecommerce/cashondel";
$route['admin/subscription'] = "admin/ecommerce/subscdetails";
$route['admin/subscription/edit'] = "admin/ecommerce/subscdetails/setDetails";
$route['admin/subscription/delete'] = "admin/ecommerce/subscdetails/deleteDetails";
$route['admin/subscription/update'] = "admin/ecommerce/subscdetails/updatedetails";
$route['admin/userhistory'] = "admin/ecommerce/userhistory";
$route['admin/userhistory/(:num)'] = "admin/ecommerce/userhistory/index/$1";

$route['admin/subscriptionorders'] = "admin/ecommerce/Subscription_management";
$route['admin/subscriptionorders/confirm'] = "admin/ecommerce/Subscription_management/confirmorder";
$route['admin/subscriptionorders/reject'] = "admin/ecommerce/Subscription_management/rejectorder";
$route['admin/subscriptionorders/edit'] = "admin/ecommerce/Subscription_management/editorder";
$route['admin/subscriptionorders/rejected_orders'] = "admin/ecommerce/Subscription_management/getRejected";
$route['admin/subscriptionorders/confirmed_orders'] = "admin/ecommerce/Subscription_management/getConfirmed";
$route['admin/subscriptionorders/incomplete_orders'] = "admin/ecommerce/Subscription_management/Create_new_day";
$route['admin/subscriptionorders/confirm_delivery'] = "admin/ecommerce/Subscription_management/ConfirmDelivery";
$route['admin/subscriptionorders/reject_delivery'] = "admin/ecommerce/Subscription_management/RejectDailydelivery";
$route['admin/subscriptionorders/confirmed_orders'] = "admin/ecommerce/Subscription_management/getConfirmedOrdersToday";
$route['admin/subscriptionorders/rejected_orders'] = "admin/ecommerce/Subscription_management/getRejectedOrdersToday";
$route['admin/subscriptionorders/edit_order'] = "admin/ecommerce/Subscription_management/EditDailydelivery";
$route['admin/subscriptionorders/allOrders'] = "admin/ecommerce/Subscription_management/getAllOrderstillToday";
$route['admin/subscriptionorders/userorder'] = "admin/ecommerce/Subscription_management/getUserhistorybymonth";
