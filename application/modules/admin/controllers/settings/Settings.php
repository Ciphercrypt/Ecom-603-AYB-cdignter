...
class Settings extends ADMIN_Controller
{
    ...
    private function postChecker()
    {
        ...
        if (isset($_POST['cod_limit'])) {
            $this->Home_admin_model->setValueStore('cod_limit', $_POST['cod_limit']);
            $this->session->set_flashdata('cod_limit', 'COD  limit is applied! ');
            $this->saveHistory('Apply COD limit');
            redirect('admin/settings');
        }
