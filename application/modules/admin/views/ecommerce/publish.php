...
<form method="POST" action="" enctype="multipart/form-data">
    ...
    <div class="form-group for-shop">
        ...
        <select class="selectpicker" name="cod_option">
            <option value="1" <?= isset($_POST['cod_option']) && $_POST['cod_option'] == 1 ? 'selected' : '' ?>>Yes</option>
            <option value="0" <?= isset($_POST['cod_option']) && $_POST['cod_option'] == 0 || !isset($_POST['cod_option']) ? 'selected' : '' ?>>No</option>
        </select>
    </div>
