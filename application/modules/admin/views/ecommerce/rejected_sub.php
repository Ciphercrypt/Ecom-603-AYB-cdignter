...
<h1 style="color:red;">Rejected orders</h1>
<a href="<?= base_url('admin/subscriptionorders') ?>" style="margin-left:50px;"  class="btn btn-warning" role="button"><b style="color:black;">New orders</b>
</a>
<a href="<?= base_url('admin/subscriptionorders/confirmed_orders') ?>" class="btn btn-success " style="margin-left:0px;" role="button"><b style="color:black;">Confirmed orders</b>
</a>
<hr>
...
if (true) {
    if (!empty($orders)) {
        ?>
        <input type="text" id="myInputreject" onkeyup="myFunction()" placeholder="Search for name..">
...
function myFunction() {
  ...
  input = document.getElementById("myInputreject");
