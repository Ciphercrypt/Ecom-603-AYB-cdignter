...
<h3 style="color:red; font-family:helvetica;" align="center"><b> Rejected orders/ Orders for leave </b></h3>



<a href="<?= base_url('admin/subscriptionorders/confirmed_orders') ?>" class="btn btn-success " style="margin-left:0px;" role="button"><b style="color:black;">Delivered orders</b> </a>
<a href="<?= base_url('admin/subscriptionorders/incomplete_orders') ?>" class="btn btn-danger " style="margin-left:0px;" role="button"><b style="color:black;">Not delivered orders</b>
                        ...
                        <td>
                            ...
                            <td class="relative" id="order_id-id-<?= $tr['sr_no'] ?>">
                                ...
                                <div class="confirm-result">
                                    <?php if ($tr['delivered']  == 2) { ?>
                                        <span class="label label-danger">Rejected order</span>
                            ...
                            <?php 
                        if ($tr['delivered']  == 2 ||$tr['delivered']  == 3  ){ ?>

                                <button type="button" class="btn btn-warning btn-block" style="margin-bottom:10px;" data-toggle="modal" data-target="#myModal<?=$tr['sr_no']?>">
                                Edit 
                                </button>
                                ...
                                <div class="modal" id="myModal<?=$tr['sr_no']?>">
                                        <div class="modal-dialog">
                                            ...
                                            <h4>Do you really want to edit Delivery of mr/mrs. <?= $data['name']  ?> , Continue if you are sure!<?=date("H:i:s")?></h4>
                                            <form action="<?=base_url('admin/subscriptionorders/edit_order')?>" method="POST" id="confirmform<?= $data['id']?>">
