...
<h1 style="color:green;">New orders</h1>

<a href="<?= base_url('admin/subscriptionorders/rejected_orders') ?>" style="margin-left:50px;"  class="btn btn-danger" role="button"><b style="color:black;">Rejected orders</b>
</a>
