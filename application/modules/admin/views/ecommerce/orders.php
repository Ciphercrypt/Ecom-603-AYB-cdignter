                ...
                <tbody>
                    ...
                    foreach ($orders as $tr) {
                        ...
                        <tr>
                            ...
                            <a href="tel:<?= $tr['phone']; ?>"><?= $tr['phone']; ?></a>
                            ...
                            <?php 
                        if ($tr['processed']  == 0 || $tr['processed']  == 2 ||$tr['processed']  == 3 ){ ?>
                                
                                <div style="margin-bottom:4px;"><a href="javascript:void(0);" onclick="changeOrdersOrderStatus(<?= $tr['id'] ?>, 4)" class="btn btn-success btn-sm active btn-block" role="button" aria-pressed="true">Complete</a></div>
                                <div style="margin-bottom:4px;"><a href="javascript:void(0);" onclick="changeOrdersOrderStatus(<?= $tr['id'] ?>, 3, '<?= htmlentities($tr['products']) ?>', '<?= $tr['email'] ?>')" class="btn btn-info btn-warning active btn-block" role="button" aria-pressed="true">Process</a></div>
                                <div style="margin-bottom:4px;"><a href="tel:<?= $tr['phone']; ?>" onclick="changeOrdersOrderStatus(<?= $tr['id'] ?>, 2)" class="btn btn-info btn-sm active btn-block" role="button" aria-pressed="true">Confirm</a></div>
                                <div style="margin-bottom:4px;"><a href="javascript:void(0);" onclick="changeOrdersOrderStatus(<?= $tr['id'] ?>, 1)" class="btn btn-danger btn-sm active btn-block" role="button" aria-pressed="true">Reject</a></div>
                            </td>
                            <?php } 
                            else if ($tr['processed']  == 1 || $tr['processed']  == 4 ){ ?>
                            
                                <div style="margin-bottom:4px;"><a href="javascript:void(0);" onclick="changeOrdersOrderStatus(<?= $tr['id'] ?>, 0)" class="btn btn-primary btn-sm active btn-block" role="button" aria-pressed="true">Edit </a></div>
