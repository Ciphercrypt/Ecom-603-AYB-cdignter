...
<div class="row">
        ...
        <div class="panel panel-success col-h">
            ...
            <div class="panel-body">
                ...
                <form accept-charset="utf-8" method="post" enctype="multipart/form-data" action="">
                    ...
                    <input type="submit" value="Upload New" name="uploadimage" class="btn btn-success" />
                </form>
            </div>
        </div>
    </div>
                ...
                <form method="POST" action="">
                    <div class="input-group">
                        ...
                        <span class="input-group-btn">
                            <button class="btn btn-success" value="" type="submit">
            ...
            <div class="panel-body">
                ...
                <form method="POST" action="">
                    <div class="input-group">
                        ...
                        <span class="input-group-btn">
                            <button class="btn btn-success" value="" placeholder="Find product.." type="submit">
                                <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                            </button>
                        </span>
                    </div>
        ...
        <div class="panel panel-success col-h">
            ...
            <div class="panel-body">
                ...
                <form method="POST" action="">
                    ...
                    <div class="form-group">
                        <input type="submit" class="btn btn-success" name="footerContacts" value="Update">
                    </div>
                </form>
            </div>
        </div>
        ...
        <div class="panel panel-success col-h">
            ...
            <div class="panel-body">
                ...
                <form method="POST" action="">
                    ...
                    <div class="form-group">
                        <input type="submit" class="btn btn-success" name="footerSocial" value="Update">
                    </div>
                </form>
            </div>
        </div>
    ...
    <div class="col-sm-6 col-md-4">
        <div class="panel panel-success col-h">
            ...
            <div class="panel-body">
                ...
                <form method="POST" action="">
                    <div class="input-group">
                        <input class="form-control" name="shippingOrder" value="<?= $shippingOrder ?>" type="number">
                        <span class="input-group-btn">
                            <button class="btn btn-success" value="" type="submit">
                                <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                            </button>
    ...
    <div class="col-sm-6 col-md-4">
        <div class="panel panel-success col-h">
            <div class="panel-heading">Cash on delivery option available for equal to or more than:</div>
            <div class="panel-body">
                <?php if ($this->session->flashdata('cod_limit')) { ?>
                    <div class="alert alert-info"><?= $this->session->flashdata('cod_limit') ?></div>
                <?php } ?>
                <form method="POST" action="">
                    <input type="number" style="margin-bottom:5px;" name="cod_limit" class="form-control" value="<?= $cod_limit ?>"></input>
                    <button class="btn btn-success" value="" type="submit">
                        Save
                    </button>
                </form>
        ...
        <div class="panel panel-success col-h">
            ...
            <div class="panel-body">
                ...
                <form method="POST" action="">
                    ...
                    <button class="btn btn-success" name="setCookieLaw" value="" type="submit">
                        Save
                    </button>
                </form>
            </div>
