        ...
        <div id="wrapper">
            <div id="content">
                <?php if ($this->session->userdata('logged_in')) { ?>
                    <nav class="navbar navbar-default">
                        ...
                        <div id="navbar" class="collapse navbar-collapse" style="background-color:black; ">
                            ...
                            <li style="margin-top:10px;"><img src="<?= base_url('assets/imgs/dudhaiim.png') ?>" alt="dudhai"> </li>

                                <li><a href="<?= base_url('admin') ?>"><i class="fa fa-home" style="color:orange"></i> Home</a></li>
                                <li><a href="<?= base_url() ?>" target="_blank"><i class="glyphicon glyphicon-star" style="color:orange"></i> Production</a></li>
                                <li>
                                    <a href="javascript:void(0);" class="h-settings"><i class="fa fa-key" aria-hidden="true" style="color:orange"></i> Pass Change</a>
                                    <div class="relative">
                                        <div class="settings">
                                ...
                                <li style="color:green"><a href="javascript:void(0);" data-toggle="modal" data-target="#modalCalculator"><i class="fa fa-calculator" aria-hidden="true" style="color:orange"></i> Calculator</a></li>
                            </ul>
                            <ul class="nav navbar-nav navbar-right">
                                <li><a href="<?= base_url('admin/logout') ?>"><i class="fa fa-sign-out" style="color:red"></i> Logout</a></li>
                            </ul>
                        </div>
                    </nav>
                <?php } ?>
                <div class="container-fluid bg-blue text-white"> 
                    <div class="row">
                        <?php if ($this->session->userdata('logged_in')) { ?>
                            <div class="col-sm-3 col-md-3 col-lg-2 left-side navbar-default bg-danger" >
                                <div class="show-menu">
                                ...
                                <ul class="sidebar-menu bg-blue text-white " style="background-color:black;"  >
                                    ...
                                    <li class="header" style="color:orange">ECOMMERCE</li>
                                    ...
                                    <li><a href="<?= base_url('admin/cashondel') ?>" <?= urldecode(uri_string()) == 'admin/cashondel' ? 'class="active"' : '' ?>><i class="fa fa-edit" aria-hidden="true"></i> Cash on delivery management</a></li>
                                    <li><a href="<?= base_url('admin/userhistory') ?>" <?= urldecode(uri_string()) == 'admin/userhistory' ? 'class="active"' : '' ?>><i class="glyphicon glyphicon-user" aria-hidden="true"></i> User order history</a></li>
                                    <li class="header" style="color:orange">Monthly subscription </li>

                                    <li><a href="<?= base_url('admin/subscription') ?>" <?= urldecode(uri_string()) == 'admin/subscription' ? 'class="active"' : '' ?>><i class="glyphicon glyphicon-gift" aria-hidden="true"></i> SUbscription management</a></li>
                                    <li><a href="<?= base_url('admin/subscriptionorders') ?>" <?= urldecode(uri_string()) == 'admin/subscriptionorders' ? 'class="active"' : '' ?>><i class="glyphicon glyphicon-list-alt" aria-hidden="true"></i>subscription Orders</a></li>
                                    <li><a href="<?= base_url('admin/subscriptionorders/incomplete_orders') ?>" <?= urldecode(uri_string()) == 'admin/subscriptionorders/incomplete_orders' ? 'class="active"' : '' ?>><i class="glyphicon glyphicon-list-alt" aria-hidden="true"></i>Todays Delivery</a></li>
                                    <li><a href="<?= base_url('admin/subscriptionorders/allOrders') ?>" <?= urldecode(uri_string()) == 'admin/subscriptionorders/allOrders' ? 'class="active"' : '' ?>><i class="glyphicon glyphicon-list-alt" aria-hidden="true"></i>All Orders </a></li>




                                    <?php if (in_array('blog', $activePages)) { ?>
                                        <li class="header" style="color:orange" >BLOG</li>
                                    ...
                                    ?>
                                    <li class="header" style="color:orange">SETTINGS</li>
                                    ...
                                    <li class="header" style="color:orange">ADVANCED SETTINGS</li>
