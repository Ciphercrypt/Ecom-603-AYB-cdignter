...
<button type="button" class="btn btn-secondary btn-lg btn-block" style="background-color:#333;color:white;" onclick="location.href='#home-slider'"><span class="glyphicon glyphicon-eject">&nbsp</span>
Back to Top</button>
</div>
